        ...
        <div className="flex gap-5 overflow-x-auto scrollbar-hide pb-4">
          {t.steps.map((step) => (
            <div key={step.num}
              ...
              style={{ backgroundColor: "var(--axis-charcoal)", border: "1px solid rgba(182,119,73,0.2)" }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(182,119,73,0.5)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 20px 40px rgba(182,119,73,0.1)"; }}
