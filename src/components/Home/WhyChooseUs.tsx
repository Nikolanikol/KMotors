...
const ICONS = [
  <svg key="1" width="48" height="48" viewBox="0 0 48 48" fill="none">
    <defs><linearGradient id="wcu1" x1="0" y1="0" x2="48" y2="48"><stop offset="0%" stopColor="#b67749"/><stop offset="100%" stopColor="#b67749"/></linearGradient></defs>
  ...
  <svg key="2" width="48" height="48" viewBox="0 0 48 48" fill="none">
    <defs><linearGradient id="wcu2" x1="0" y1="0" x2="48" y2="48"><stop offset="0%" stopColor="#b67749"/><stop offset="100%" stopColor="#b67749"/></linearGradient></defs>
  ...
  <svg key="3" width="48" height="48" viewBox="0 0 48 48" fill="none">
    <defs><linearGradient id="wcu3" x1="0" y1="0" x2="48" y2="48"><stop offset="0%" stopColor="#b67749"/><stop offset="100%" stopColor="#b67749"/></linearGradient></defs>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {t.features.map((feature, i) => (
            <div key={i}
              ...
              style={{ backgroundColor: "var(--axis-graphite)", border: "1px solid rgba(182,119,73,0.2)" }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(182,119,73,0.5)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 20px 40px rgba(182,119,73,0.15)"; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(182,119,73,0.2)"; (e.currentTarget as HTMLElement).style.boxShadow = "none"; }}
            >
