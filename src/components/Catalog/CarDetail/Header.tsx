    ...
    <header className="rounded-2xl p-6 space-y-6" style={{ backgroundColor: "var(--axis-charcoal)", border: "1px solid rgba(74,74,74,0.3)" }}>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
        <div className="flex-1 space-y-3">
          ...
          <div>
            <span className="px-3 py-1 rounded-full text-xs font-semibold" style={{ backgroundColor: "rgba(182,119,73,0.12)", color: "var(--axis-orange)", border: "1px solid rgba(182,119,73,0.3)" }}>
      ...
      <div className="pt-4 border-t" style={{ borderColor: "rgba(74,74,74,0.3)" }}>
        <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
          <a
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(182,119,73,0.4)"; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(74,74,74,0.3)"; }}
          >
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: "rgba(182,119,73,0.12)", color: "var(--axis-orange)" }}>
          ...
          <div className="flex flex-col gap-2 px-4 py-3 rounded-2xl" style={{ backgroundColor: "var(--axis-graphite)", border: "1px solid rgba(74,74,74,0.3)" }}>
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "rgba(182,119,73,0.08)", color: "var(--axis-gray)" }}>
          ...
          <div className="flex items-center gap-3 px-4 py-3 rounded-2xl" style={{ backgroundColor: "var(--axis-graphite)", border: "1px solid rgba(74,74,74,0.3)" }}>
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: "rgba(182,119,73,0.08)", color: "var(--axis-gray)" }}>
