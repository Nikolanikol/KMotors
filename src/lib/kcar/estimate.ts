...
// по 11 537 сделкам медиана превышения +8.2%. Показать клиенту старт — значит
// назвать цену, по которой машину купить нельзя. Считаем медианную премию по
// истории и применяем её к старту.
//
