 ...
 *
 * Не задана — сбор равен нулю, то есть поведение ровно как до 27.08.2026.
 * Это осознанный выбор: тихо прибавить НЕ ТУ сумму хуже, чем не прибавить
 * ничего. Переменную обязательно задать в окружении прода.
 */
export const CAR_STORAGE_FEE_KRW = Math.max(
  0,
  Number(process.env.NEXT_PUBLIC_CAR_STORAGE_FEE_KRW) || 0,
);
