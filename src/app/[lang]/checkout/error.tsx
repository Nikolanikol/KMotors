  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 bg-[#F5F7FA]">
      <div className="max-w-md w-full text-center space-y-5">
        ...
        <div>
          <h2 className="text-xl font-bold text-[#002C5F] mb-1">Ошибка оформления заказа</h2>
          <p className="text-sm text-gray-500">Ваш заказ не был оформлен. Попробуйте снова.</p>
        </div>
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/ru/account?tab=cart" className="px-5 py-2.5 border border-gray-200 text-gray-600 rounded-xl text-sm font-semibold hover:bg-gray-50 transition">
            Назад в корзину
          </Link>
        </div>
