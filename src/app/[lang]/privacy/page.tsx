...
const PRIVACY_CONTENT: Record<string, {
  ...
  ru: {
    ...
    sections: [
      ...
      {
        title: "6. Ваши права",
        text: "Вы вправе запросить доступ к своим данным, потребовать их исправления или удаления. Для этого свяжитесь с нами через Telegram: @kmotorsshop или по телефону +82 10-7732-4344.",
      },
      {
        title: "7. Контакты",
  ...
  en: {
    ...
    sections: [
      ...
      {
        title: "6. Your rights",
        text: "You have the right to request access to your data, request its correction or deletion. To do so, contact us via Telegram: @kmotorsshop or by phone +82 10-7732-4344.",
      },
      {
        title: "7. Contact",
  ...
  ko: {
    ...
    sections: [
      ...
      {
        title: "6. 귀하의 권리",
        text: "데이터 접근, 수정 또는 삭제를 요청할 권리가 있습니다. 텔레그램 @kmotorsshop 또는 전화 +82 10-7732-4344로 문의하세요.",
      },
      {
        title: "7. 연락처",
  ...
  ka: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "გაქვთ უფლება მოითხოვოთ მონაცემებზე წვდომა, მათი შესწორება ან წაშლა. დაგვიკავშირდით Telegram-ზე: @kmotorsshop ან ტელეფონით +82 10-7732-4344.",
      },
      {
        title: "7. კონტაქტი",
  ...
  ar: {
    ...
    sections: [
      ...
      {
        title: "6. حقوقك",
        text: "يحق لك طلب الوصول إلى بياناتك أو تصحيحها أو حذفها. تواصل معنا عبر تيليغرام: @kmotorsshop أو هاتف +82 10-7732-4344.",
      },
      {
        title: "7. التواصل",
