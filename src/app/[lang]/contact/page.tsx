...
const CONTACT_META: Record<string, { title: string; description: string }> = {
  ru: {
    title: "Контакты K-Axis — заказать авто из Кореи",
    description: "Свяжитесь с K-Axis для заказа автомобиля из Южной Кореи. Telegram, WhatsApp, телефон. Доставка в Россию, Казахстан, Узбекистан, Грузию.",
  },
  en: {
    title: "Contact K-Axis — Order a Car from Korea",
    description: "Contact K-Axis to order a car from South Korea. Telegram, WhatsApp, phone. Delivery to Russia, Kazakhstan, Uzbekistan, Georgia.",
  },
  ko: {
    title: "K-Axis 연락처 — 한국 자동차 주문",
    description: "한국에서 자동차를 주문하려면 K-Axis에 문의하세요. 텔레그램, WhatsApp, 전화. 러시아, 카자흐스탄, 우즈베키스탄, 조지아 배송.",
  },
  ka: {
    title: "K-Axis კონტაქტი — კორეიდან ავტომობილის შეკვეთა",
    description: "დაუკავშირდით K-Axis-ს კორეიდან ავტომობილის შესაკვეთად. Telegram, WhatsApp, ტელეფონი. მიტანა საქართველოში.",
  },
  ar: {
    title: "تواصل مع K-Axis — اطلب سيارة من كوريا",
    description: "تواصل مع K-Axis لطلب سيارة من كوريا الجنوبية. تيليغرام، واتساب، هاتف. التوصيل إلى روسيا وكازاخستان وأوزبكستان وجورجيا.",
  },
};

const FAQ_BY_LANG: Record<string, { q: string; a: string }[]> = {
  ru: [
    { q: "Как связаться с K-Axis?", a: "Вы можете связаться с нами через Telegram, WhatsApp или по телефону. Заполните форму на сайте — менеджер ответит в ближайшее время." },
  ...
  en: [
    { q: "How to contact K-Axis?", a: "You can reach us via Telegram, WhatsApp, or phone. Fill out the form on the website — a manager will respond shortly." },
  ...
  ko: [
    { q: "K-Axis에 연락하는 방법?", a: "텔레그램, WhatsApp 또는 전화로 연락하실 수 있습니다. 웹사이트 양식을 작성하시면 담당자가 빠르게 답변드립니다." },
  ...
  ka: [
    { q: "როგორ დავუკავშირდე K-Axis-ს?", a: "შეგიძლიათ დაგვიკავშირდეთ Telegram-ით, WhatsApp-ით ან ტელეფონით. შეავსეთ ფორმა — მენეჯერი მალე გიპასუხებთ." },
  ...
  ar: [
    { q: "كيف أتواصل مع K-Axis؟", a: "يمكنك التواصل معنا عبر تيليغرام أو واتساب أو الهاتف. املأ النموذج على الموقع وسيرد عليك مدير قريبًا." },
