    ...
    <div className="bg-[#F5F7FA] min-h-screen" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="relative overflow-hidden bg-[#002C5F]">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[var(--axis-bronze-deep)] bg-[image:var(--axis-bronze-fill)] rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3" />
