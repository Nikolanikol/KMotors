...
// паузой 1.2 с — это порядка часа. Он НЕ должен стоять в ежедневном
// расписании рядом с обычным прогоном: ставить отдельной, редкой задачей и
// с запасом по таймауту на стороне curl.
//
// ⚠️ Но пустой ответ теперь приходит за минуту, а не за час: если в первых
// 12 карточках витрины нет лотов KCar, обход прерывается с пояснением в
// notes.aborted. Витрина чужая и её наполнение меняется — 12.09.2026 она
// целиком переехала на Lotte.
