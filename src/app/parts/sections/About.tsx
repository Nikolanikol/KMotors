        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mt-20">
          {ADV_KEYS.map((key, index) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 rounded-full bg-[var(--pn-surface-3)] flex items-center justify-center mx-auto mb-4 group-hover:bg-[var(--pn-orange-deep)] transition-colors">
