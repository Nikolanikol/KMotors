    ...
    <div className="py-10 sm:py-14">
      <div className="max-w-2xl mx-auto rounded-2xl border border-[var(--pn-orange)]/30 bg-[var(--pn-surface)] overflow-hidden shadow-xl">
        ...
        <div className="px-6 sm:px-8 pt-8 pb-6 text-center bg-gradient-to-b from-[var(--pn-orange)]/10 to-transparent">
          <div className="w-14 h-14 rounded-full bg-[var(--pn-orange)]/15 border border-[var(--pn-orange)]/30 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="px-6 sm:px-8 pb-6 space-y-3">
          <button
            onClick={openOrder}
            className="w-full h-12 rounded-xl bg-[var(--pn-orange)] text-white font-semibold text-base hover:brightness-110 transition-all shadow-lg shadow-[var(--pn-orange)]/20"
          >
