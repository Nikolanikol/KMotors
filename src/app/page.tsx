...
export default function Home() {
  return (
    <div className="  min-h-[70vh]">
      <Main />
      <div className="py-20 rounded-[100px] mt-[-100px] relative z-10 bg-white  overflow-hidden">
        <CarSlider
          reqString="https://encar-proxy-main.onrender.com/api/catalog?count=true&q=(And.Hidden.N._.(C.CarType.Y._.Manufacturer.%ED%98%84%EB%8C%80.))&sr=%7CModifiedDate%7C%7C20"
          title="Kia"
        />
        <CarSlider
